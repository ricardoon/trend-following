    ...
    public function rules()
    {
        ...
        if ($method === 'PATCH') {
            return [
                ...
                'category' => 'sometimes|string|max:255|in:crypto,option_br,stock_br,stock_us,stock_no',
            ...
            return [
                ...
                $bulk . 'category' => 'required|string|max:255|in:crypto,option_br,stock_br,stock_us,stock_no',
