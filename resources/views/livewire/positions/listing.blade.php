    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700">{{ __('A list with all the active positions.') }}</p>
            </div>
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <button type="button" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">{{ __('Add position') }}</button>
            </div>
        </div>
        ...
        @else
            <div class="mt-6 overflow-hidden bg-white rounded-lg shadow">
                <div class="py-8 text-center">
                    <i class="text-3xl text-gray-400 rotate-45 fal fa-fw fa-ticket-alt"></i>
                    <h3 class="mt-2 font-medium text-gray-900">{{ __('No position found.') }}</h3>
